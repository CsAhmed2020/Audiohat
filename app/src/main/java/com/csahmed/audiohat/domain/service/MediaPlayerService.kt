package com.csahmed.audiohat.domain.service
...
import com.csahmed.audiohat.domain.exoplayer.MediaPlayerNotificationManager
import com.csahmed.audiohat.domain.exoplayer.MediaSource
...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    private fun preparePlayer(
        ...
        exoPlayer.setMediaSource(
            mediaSource.asMediaSource(dataSourceFactory)
        )
        exoPlayer.prepare()
